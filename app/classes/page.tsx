...
export default function ClassesPage() {
  ...
  }).filter((cls): cls is NonNullable<typeof cls> => cls !== null && cls !== undefined).filter((cls: any) => cls.sections.length > 0 || cls.name.toLowerCase().includes(searchTerm.toLowerCase()));
